...
public class FunctionServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (request.getParameter("action").equals("ultimiinseriti")) {
			...
			out.println(risjson);
			return;
		} else if (request.getParameter("action").equals("consigliati")) {
			String u = (String) request.getSession().getAttribute("loggeduser");
			// System.out.println("logged in cons" + u);
			SearchService searchservice = new SearchService();
			BraniService braniservice = new BraniService();
			String genere = "";
			if (u == null || u.isEmpty()) {
				...
				genere = braniservice.getGenerePiuAscoltato(u);
			...
			String u = (String) request.getSession().getAttribute("loggeduser");
			// String linkVideo= (String)
			// request.getSession().getAttribute("linkVideo");
