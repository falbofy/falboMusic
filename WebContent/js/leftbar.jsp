		<div class="left-side sticky-left-side">
			...
			<div class="logo">
				<h1><a href="index.jsp">FalboMusi<span>c</span></a></h1>
			</div>
			<div class="logo-icon text-center">
				<a href="index.jsp">FM </a>
			</div>
 	 <!-- /w3l-agile -->
			...
			<div class="left-side-inner">
				...
				<!--sidebar nav start-->
					...
					<!--    <li><a href="radio.html"><i class="camera"></i> <span>Radio</span></a></li> 
						...
						<li><a href="brani.jsp"><i class="lnr lnr-music-note"></i> <span>Brani</span></a></li> 
					 	<li><a href="artisti.jsp"><i class="lnr lnr-users"></i> <span>Artisti</span></a></li>						
