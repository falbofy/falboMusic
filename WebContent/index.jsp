...
<html>
<head>
<title>Mosaic a Entertainment Category Flat Bootstrap Responsive
	...
	<section>
							...
							<div class="sign">
								...
								<div class="sign-right">
									<form id=registerForm method="post">
										...
										<input type="text" value="Name" id="nome"
											onfocus="this.value = '';"
											onblur="if (this.value == '') {this.value = 'Name';}"
											required=""> <input type="text" value="Cognome"
											id="cognome" onfocus="this.value = '';"
											onblur="if (this.value == '') {this.value = 'Name';}"
											required=""> <input type="text" value="Username"
											id="usrreg" name="usr" onfocus="this.value = '';"
											onblur="if (this.value == '') {this.value = 'Name';}"
											required="" onchange="controllauser();">
										<div id="availability" class="form-group"></div>

										<!--	<input type="text" value="Mobile number" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Mobile number';}" required="">
								    		<input type="text" value="Email id" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Email id';}" required="">	-->
										<input type="password" value="Password" id="pswreg"
											onfocus="this.value = '';"
											onblur="if (this.value == '') {this.value = 'Password';}"
											required=""> <input type="password" value="Password"
											id="pswrepeat" onfocus="this.value = '';"
											onblur="if (this.value == '') {this.value = 'Password';}"
											required="">
										<div id="statusreg" class="form-group"></div>
										<input type="button" value="CREATE ACCOUNT"
											id="submitregbutton" onclick="registraUtente();"
											style="display: none">
									</form>
								</div>
								<div class="clearfix"></div>
		...
		<div class="main-content">
					...
					<div class="music-left">
						...
						<div class="albums">
							<div class="tittle-head">
								<h3 class="tittle">
									Ultimi brani Aggiunti <span class="new">New</span>
								</h3>
			...
			<div class="review-slider">
				<div class="tittle-head">
					<h3 class="tittle">
						Featured Albums <span class="new"> New</span>
					</h3>
					<div class="clearfix"></div>
				</div>
				<ul id="flexiselDemo1">
